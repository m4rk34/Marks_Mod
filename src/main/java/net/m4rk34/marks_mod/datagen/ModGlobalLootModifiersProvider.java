...
import net.m4rk34.marks_mod.loot.AddItemModifier;
import net.m4rk34.marks_mod.loot.AddSusSandItemModifier;
...
public class ModGlobalLootModifiersProvider extends GlobalLootModifierProvider {
    ...
    protected void start() {
        add("pine_cone_from_grass", new AddItemModifier(new LootItemCondition[] {
                ...
                LootItemRandomChanceCondition.randomChance(0.05f).build()}, ModItems.PINE_CONE.get()));
