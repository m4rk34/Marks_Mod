...
public enum ModArmorMaterials implements ArmorMaterial {
    ...
    //PINK_DIAMOND("pink_diamond", 26, new int[]{ 5, 7, 6, 4 }, 25,
            //SoundEvents.ARMOR_EQUIP_DIAMOND, 2f, 0f, () -> Ingredient.of(ModItems.PINK_DIAMOND.get())),
    PINK_DIAMOND("pink_diamond", 26, new int[]{ 3, 8, 6, 3 }, 25,
            SoundEvents.ARMOR_EQUIP_DIAMOND, 2f, 0f, () -> Ingredient.of(ModItems.PINK_DIAMOND.get()));
